...
const styles = StyleSheet.create({
  ...
  timer: { fontFamily: F.black, fontSize: 12, lineHeight: 16, color: C.gold },
  row: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  name: { fontFamily: F.black, fontSize: 15, lineHeight: 20, includeFontPadding: false },
  ...
  scarce: { fontFamily: F.black, fontSize: 11, lineHeight: 15, color: C.piment },
