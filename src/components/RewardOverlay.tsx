...
const styles = StyleSheet.create({
  ...
  gains: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', gap: 16 },
  gain: { flexDirection: 'row', alignItems: 'baseline', gap: 4 },
  gainIcon: { fontSize: 24 },
  gainValue: {
    fontFamily: F.black,
    fontSize: 44,
    lineHeight: 58,
  ...
  gainUnit: { fontFamily: F.black, fontSize: 15, lineHeight: 20, color: C.textDim },
  item: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
  ...
  honor: { fontFamily: F.black, fontSize: 15, lineHeight: 20 },
  bonuses: { flexDirection: 'row', gap: 8, flexWrap: 'wrap', justifyContent: 'center' },
