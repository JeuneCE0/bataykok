...
export const DICT = {
  ...
  'defense.allHeld': { fr: 'Ton kok a tout repoussé. Beau travail !', rcf: 'Out kok la tout ropousé. Bien zoué !' },
  'defense.noneHeld': { fr: 'Personne n’a été repoussé. Il faut renforcer ton kok.', rcf: 'Personn la pa été ropousé. Fo ranforsé out kok.' },
  'defense.someHeld': { fr: '{n} défenses gagnées sur {total}.', rcf: '{n} défans gagné sï {total}.' },
  'chest.ready': { fr: 'Ton coffre est prêt !', rcf: 'Out kofr lé paré !' },
  'chest.brewing': { fr: 'Coffre en préparation', rcf: 'Kofr an préparasion' },
  'chest.contents': { fr: 'Grains, piments ou un ékipman — au hasard.', rcf: 'Grin, pima ou bien in ékipman — o azar.' },
  'chest.availableIn': { fr: 'Disponible dans {t}', rcf: 'Dispo dan {t}' },
  'arena.streak': { fr: '🔥 {n} victoire d’affilée', rcf: '🔥 {n} viktoir dsuit' },
  'arena.streak_n': { fr: '🔥 {n} victoires d’affilée', rcf: '🔥 {n} viktoir dsuit' },
  'arena.lossNote': { fr: 'Ton kok a pris un coup, mais il a appris. Entraîne-le !', rcf: 'Out kok la pri in kou, mé li la apri. Antrène ali !' },
  'referral.offline': { fr: 'Il faut être en ligne pour parrainer. Ton code arrive dès que la connexion revient.', rcf: 'Fo èt an lign pou parène. Out kod i ariv dès ke la konèksion i rovien.' },
  'dungeon.bossWon': { fr: '🏆 GARDIEN VAINCU !', rcf: '🏆 GARDIEN VINKU !' },
  'dungeon.bossLost': { fr: '💀 ÇA N’EST PAS PASSÉ…', rcf: '💀 SA LA PA PASSÉ…' },
  'dungeon.bossNote': {
